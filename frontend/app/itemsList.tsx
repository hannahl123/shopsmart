...
export default function ItemsList() {
    ...
    const addItem = () => {
        if (newItemName && newItemDate) {
            setTableData([
                ...tableData,
                { item: newItemName, date: newItemDate, select: "Select" },
            ]);
            setNewItemName("");
            setNewItemDate("");
    ...
    return (
        <View style={styles.view}>
            ...
            <Text
                style={[
                    styles.header,
                    { fontWeight: "bold", fontSize: 25, marginBottom: "5%" },
                ]}>
                YOUR ITEMS
            </Text>
            <View
            ...
            <View
                ...
                <View style={styles.headerRow}>
                    ...
                    <Text style={[styles.headerText, { marginRight: "-22%" }]}>
                        Select
                    </Text>
                </View>
                ...
                <ScrollView style={{ maxHeight: "100%" }}>
                    {tableData.map((row, index) => (
                        <View key={index} style={styles.row}>
                            ...
                            <Text style={[styles.cell, { marginLeft: "-10%" }]}>
                                {row.date}
                            </Text>
                            <TouchableOpacity
                                style={[
